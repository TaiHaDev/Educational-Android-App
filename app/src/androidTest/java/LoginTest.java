...
import com.example.ga_23s1_comp2100_6442.BigfilterPage;
import com.example.ga_23s1_comp2100_6442.LoginPage;
...
public class LoginTest {
    ...
    public void testLoginSuccess() throws InterruptedException {
        ...
        Espresso.onView(ViewMatchers.withId(R.id.text_choose_field)).check(matches(isDisplayed()));
